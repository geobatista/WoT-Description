jQuery(function($){
    $('#ActuatableProperty').selectize({
        load: function(query, callback) {
            var url = '/app-sensor-catalog/Actuator-Model/ActuatableProperty.rq?results&tqx=out:sparql-json&keyword=' + encodeURIComponent(query);
