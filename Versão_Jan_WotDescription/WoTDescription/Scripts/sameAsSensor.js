jQuery(function($){
    $('#sameAsSensor').selectize({
        load: function(query, callback) {
            var url = 'http://localhost:8080/ProjetoFinal/WoTDescription/Queries/sameAsSensor.rq?results&tqx=out:sparql-json&keyword=' + encodeURIComponent(query);
